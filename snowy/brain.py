...
class SnowyBrain:
    ...
    def __init__(self):
        ...
        # Updated on every think() call - succeeds → True, 429 → False.
        # No background polling: each button press naturally retries,
        # so Snowy recovers on her own once the daily quota resets.
        self.quota_ok = True
